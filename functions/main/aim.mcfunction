...
#get coordinates
function main:get_pos
execute @e[tag=aim_at] ~ ~ ~ function main:get_pos

#aim.x, aim.y, aim.z

scoreboard players remove @e[tag=aim_at] y 1
...
# calculate rrx & rry
function main:aim/rrx
function main:aim/rry

#adjust
scoreboard players set main_aim_tmp tmp 90
scoreboard players operation @s aim.x = main_aim_x aim.x
scoreboard players operation @s aim.y = main_aim_y aim.y
scoreboard players operation @s aim.z = main_aim_z aim.z
scoreboard players add @s[score_aim.x=-1,score_aim.z=-1] rry 270
scoreboard players add @s[score_aim.x_min=0,score_aim.z_min=0] rry 90
...
scoreboard players add @s[score_aim.x=-1,score_aim.z_min=0] rry 180
